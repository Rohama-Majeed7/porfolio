...
const SingleProject = ({
  ...
  return (
    <section className="fixed top-0 left-0 w-full h-full bg-[#0a0a0acc] backdrop-blur-md z-50 flex justify-center items-center p-2 md:p-4">
      <main
        className={`relative w-full max-w-4xl bg-[#1a2328] rounded-2xl border border-[#4fced5] shadow-[0_0_60px_4px_rgba(79, 206, 213, 0.35)] p-4 md:p-6 transition-transform duration-300 ease-in-out ${
      ...
      >
        <FaTimes
          ...
          className="absolute top-3 right-4 text-2xl md:text-3xl text-white hover:text-[#4fced5] cursor-pointer transition-all duration-200"
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 items-center">
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            ...
            <div>
              <p className="text-[#4fced5] font-semibold mb-1">Description:</p>
            ...
            <div className="flex gap-4 mt-2 text-xl md:text-2xl">
              {singleProject.link && (
                <Link
                  ...
                  target="_blank"
                  className="text-[#4fced5] hover:text-[#fff] transition-all"
                >
                  <CiLink />
                </Link>
              )}
